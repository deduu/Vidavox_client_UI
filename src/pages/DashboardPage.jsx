...
export default function DashboardPage() {
  ...
  const toggleSelect = (node, event) => {
    ...
    // remember last clicked for next shift
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
        <div className="max-w-7xl mx-auto p-6 space-y-6">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="space-y-1">
              ...
              <p className="text-lg text-gray-600 font-light">
                Manage your files and knowledge bases with ease
              </p>
            </div>
          ...
          <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/30 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-600/10 to-indigo-600/10 px-6 py-4 border-b border-gray-100">
