...
export const THEME = {
  ...
  pageBg: "bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50", // no min-h, no padding, no gaps
  pageBgFit: "bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50", // no min-h, no padding, no gaps
